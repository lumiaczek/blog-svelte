...
<section class="h-screen bg-blue-600 flex justify-center items-center">
        <div class="flex flex-col items-center space-y-4">
            <form on:submit|preventDefault class="overflow-hidden bg-white rounded-lg shadow-xl">
                <div class=" px-10 pt-8 pb-6 text-center ">
                    ...
                    <div class="flex flex-col space-y-4 text-left">
                        <div>
                            ...
                            <input type="email" bind:value={dane.email} class="input" id="login" name="login">
                        </div>
                        <div>
                            <label for="pass" class="text-left">
                                <span class="text-gray-600 text-sm mb-1 block ">Password</span>
                            </label>
                            <input type="password" bind:value={dane.password} class="input" id="pass" name="pass">
                        </div>
                ...
                <footer class=" flex items-center justify-center space-x-2 px-10 py-4 bg-gray-100 border-t border-gray-200">
